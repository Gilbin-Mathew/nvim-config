...
--  -- cursor and else --
--  M.hi(0, "Cursor", {fg = "#f0ec8c", bg = "#f0ec8c", bold = true })
...
--  M.hi(0, "StatusLineNC", { fg = "#3B4252", bg = "#1F2335" })


  M.hi(0, "MatchParen", { fg = "#ff1493", bg = nil, bold = true, italic = true })
  M.hi(0, "@punctuation", { fg = "#d2d7dd", bg = nil, bold = true, italic = false })
  ...
  -- Comments --
  M.hi(0, "Comment", { fg = "#ecb176", bg = nil})
  ...
  M.hi(0, "@type.qualifier", { fg = "#f0ec8c", bg = nil, bold = true, italic = false })
  M.hi(0, "StorageClass", { fg = "#f0ec8c", bg = nil, bold = true, italic = false })
